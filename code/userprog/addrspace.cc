...
bool AddrSpace::pageUsed[NumPhysPages] = {0};
...
AddrSpace::~AddrSpace()
{
	for(int i = 0; i < numPages; i++)
        	AddrSpace::pageUsed[pageTable[i].physicalPage] = false;
	delete pageTable;
}
...
//	cout << "number of pages of " << fileName<< " is "<<numPages<<endl;
    ...
    for(unsigned int i = 0, j = 0; i < numPages; i++) {
        ...
        while(j < NumPhysPages && AddrSpace::pageUsed[j] == true)
            j++;
        AddrSpace::pageUsed[j] = true;
